...
//import com.cn.ailanguage.primarychinese.databinding.ActivityBuyBinding;
...
public class BuyActivity extends AppCompatActivity implements BuyContract.BuyView, UidContract.UidView {
    ...
    private TextView buyIyubi;
    private TextView buyPolicy;
...
//            Log.e("qxy", "onCreate: clic2" + s );
        ...
        buyIyubi = findViewById(R.id.buyIyubi);
        buyIyubi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BuyActivity.this, BuyiyubiActivity.class);
                startActivity(intent);
            }
        });


        buyPolicy = findViewById(R.id.buy_policy);
        // 隐私协议点击
        SpannableString spannableString = new SpannableString(buyPolicy.getText());
        ClickableSpan clickableSpan = new ClickableSpan() {
            @Override
            public void onClick(View widget) {
                Intent intent = new Intent(BuyActivity.this, BuyPrivacyActivity.class);
                startActivity(intent);
            }
        };
        spannableString.setSpan(clickableSpan, 16, 24, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
// 将SpannableString对象设置到TextView中
        buyPolicy.setText(spannableString);
// 设置TextView可点击，以便触发ClickableSpan的点击事件
        buyPolicy.setMovementMethod(LinkMovementMethod.getInstance());
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BuyActivity.this, MainFragmentActivity.class);
                startActivity(intent);
            }
        });
        //点击全站会员
        ...
        if (buyBean.getResult().equals("200")) {
            ...
            Runnable payRunnable = () -> {
                ...
                if (result.get("resultStatus").equals("9000")) {
                    Log.e("qxy", "getBuy: "+ buyBean.getAlipayTradeStr() + " -|- " + result.toString() );
